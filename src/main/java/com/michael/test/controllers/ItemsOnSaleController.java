...
public class ItemsOnSaleController {
    ...
    public Object getRecommendations(@PathVariable Integer userId, Authentication authentication){
        ...
        if(user!=null && userDetails.getUsername().equals(user.getUserName())){      //validate if the user is calling the correct api.
            return recommendationService.getRecommendations(userId);                 //get the recommendation list
        }else {
