...
1. This project was written in Spring Boot with Maven. Configurations for DB, Scheduling and Security are in *com.michael.test.config* package.
...
4. Schedule has a thread pool size = 10.
